...
class Trainer(object):
    ...
    def schedule(self):
        ...
        return self.get_classifier_json(shared_layer)

    def get_accuracy_per_layer(self, image_dir, config_file, max_layers, layers_stride, patience, mock=False):
        for num_training_layers in range(0, max_layers, layers_stride):
            ...
            self._apps[self._app_uuid]["accuracy"][num_training_layers] = acc
    ...
    def add_app(self, name, image_dir, config_file, acc_dev_percent):
        ...
        self.get_accuracy_per_layer(image_dir, config_file, self._max_layers, 50, 0, False)
